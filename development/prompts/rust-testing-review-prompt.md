...
- [ ] Test comments follow clean, concise header format without verbose explanations
- [ ] Test comments explain "what" the test validates, not implementation details
- [ ] API documentation proportional to complexity and user needs
- [ ] Comments add genuine value for maintenance and understanding
- [ ] Consistent clean test header format without Given/When/Then clauses or benefit justifications
...
- [ ] Identify low-value tests for replacement with high-value logic:
  ...
  * **Verbose test comments** (test headers with Given/When/Then clauses, lengthy benefit explanations, or excessive justification)
...
- [ ] Consistent clean test header format without verbose explanations
- [ ] Clear test purpose documentation following clean, concise template:
```rust
/// Short descriptive title of what the test validates.
///
/// Concise explanation of what the test does and validates, without
/// lengthy justifications or Given/When/Then behavioral clauses.
#[tokio::test]
...
- **Verbose Test Headers:** Comments with Given/When/Then clauses or lengthy benefit explanations
...
- **Inconsistent Test Headers:** Test functions lacking clean, standardized header format
- **Overly Verbose Purpose Documentation:** Test headers with unnecessary justifications instead of concise descriptions
...
#### 1. Immediate Actions (Critical/High Priority):
 ...
 1.1. **Remove Redundant Tests:** Delete X tests with 90%+ redundancy to existing unit tests.  
 1.2. **Migrate Misplaced Tests:** Move Y tests to appropriate dependency projects.  
 1.3. **Fix Critical Anti-Patterns:** Address validation theater and manual business   logicimplementation

#### 2. Near-term Improvements (Medium Priority):

2.1. **Transform Integration Tests:** Convert Z tests to unit tests with proper mocking  
2.2. **Enhance Unit Test Coverage:** Fill gaps identified during redundancy analysis  
2.3. **Coordinate Cross-Project:** Work with dependency maintainers for test migration  

#### 3. Long-term Enhancements (Low Priority):

3.1. **Advanced Testing Patterns:** Implement sophisticated testing frameworks and infrastructure  
3.2. **Documentation Standards:** Create comprehensive testing guidelines and best practices  
3.3. **Performance Optimization:** Optimize test execution speed and reliability  
...
1. **Create markdown report file** in `.ai/reviews/` directory with filename format: `{module-name}-review-{YYYY-MM-DD}.md`
